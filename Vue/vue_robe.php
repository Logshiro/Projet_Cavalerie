...
if(isset($_GET['action'])){
    ...
    switch($_GET['action']){
        ...
        ob_start();
        require_once '../Controleur/Robe/PHP_CRUD_Robe/add_robe.php';
    ...
    case 'Modifier': //Modifier un produit
        ob_start();
        require_once '../Controleur/Robe/PHP_CRUD_Robe/edit_robe.php';
        $content = ob_get_clean();
        break;
    case 'Supprimer': //Supprimer un produit
        ob_start();
        require_once '../Controleur/Robe/PHP_CRUD_Robe/delete_robe.php';
        $content = ob_get_clean();
        break;
    default:
            ...
            <section class = "col-12">
                    ...
                    <tbody>
                        ...
                        foreach ($allRobe as $ligne) {
                            ...
                            <tr>
                                ...
                                <td><?= $ligne['idRobe']; ?></td>
                                <!-- On affiche le NomRobe -->
                                <td><?= $ligne['LibRobe']; ?></td>
                                <!-- On crée un lien pour voir les détails du Robe -->
                                <td><a href="vue_robe.php?id=<?= $ligne['idRobe']; ?>&action=Voir" class="btn btn-primary">Voir</a>
                                <a href="vue_robe.php?id=<?= $ligne['idRobe']; ?>&action=Modifier" class="btn btn-warning">Modifier</a>
                                <a href="vue_robe.php?id=<?= $ligne['idRobe']; ?>&action=Supprimer" class="btn btn-danger">Supprimer</a></td>
                            </tr>
                            <?php
                        }
                        ?>
                ...
                <div class="action-buttons">
                        <form method="get" style="display: inline;">
                            <button type="submit" name="action" value="add" class="btn btn-primary">Ajouter une Robe</button>
                        </form>
                        <a href="../Class/PDF/class_RobePDF.php" target="_blank" class="btn btn-pdf">
